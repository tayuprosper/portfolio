...
function Projects() {
  return (
    <div className={`${monteserat.className} mx-[3rem] lg:mx-[6rem]`} id='projects'>
        ...
        <div className="flex-col lg:flex-row projects flex lg:justify-evenly gap-4  items-center">
            <div className="rounded-lg h-fit flex flex-col shadow-xl w-full bg-white pb-4 ">
                ...
                <div className="check p-3">
                    <span className='bg-blue-300 p-3 m-2 rounded-xl text-blue-600 font-extrabold'><a href="#">Try it</a></span>
                </div>
            </div>
